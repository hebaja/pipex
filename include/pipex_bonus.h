...
/*   Updated: 2025/02/01 17:18:58 by hebatist         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		exec_pipex(t_fds *fds, t_cmd **lst_cmd, char *fcontent, int cmd_quant);
...
t_cmd	*build_lst_cmd(char **argv, t_fds *fds, char *fcontent, char **path);
